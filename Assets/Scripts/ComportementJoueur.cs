...
/*
 * Description : Gestion des statistiques du joueur tels que l'HP, l'XP, les dégâts, la vitesse, les visuels, etc...
...
public class ComportementJoueur : MonoBehaviour
{
    ...
    public TextMeshProUGUI texteVie; //Référence au texte de vie
    ...
    public AudioClip sonHit; //Son lorsque le joueur prend des dégâts
    public static float ennemisTues; //Nombre d'ennemis tués
    ...
    //Fonction permettant d'augmenter les dégâts du joueur
